...
export type OptionSet =
  | { options: Option[]; equipment_category: never; resource_list_url: never }
  | { options: never; equipment_category: DefaultRepresentation; resource_list_url: never }
  | { options: never; equipment_category: never; resource_list_url: string };
